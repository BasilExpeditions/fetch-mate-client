...
const ChatRoom = () => {
  ...
  return (
    ...
    <button className="chat-nav-profile"><Link className="navlink" to="/profile">Profile</Link></button>
    <button className="chat-nav-swipe"><Link className="navlink" to="/swipe">Swipe</Link></button>
    </nav>
